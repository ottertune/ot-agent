...
CMD python3 -m driver.main --deployment onprem --config ./driver/config/driver_config.yaml --override-db-type $OTTERTUNE_DB_TYPE --override-api-key $OTTERTUNE_API_KEY --override-db-key $OTTERTUNE_DB_KEY --override-organization-id $OTTERTUNE_ORG_ID --override-db-username $OTTERTUNE_DB_USERNAME --override-db-password $OTTERTUNE_DB_PASSWORD --override-hostname $OTTERTUNE_HOSTNAME --override-port $OTTERTUNE_PORT

...
def _test_config_data() -> Dict[str, Any]:
    partial_config_from_file: Dict[str, Any] = {
        ...
        "long_running_query_monitor_interval": 120,
...
def test_partial_config_from_file_success(
    ...
    assert partial_config.long_running_query_monitor_interval == 120
    assert partial_config.lr_query_latency_threshold_min == 2
